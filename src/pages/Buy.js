        ...
        >
          <Stack direction="row" alignItems="center" gap={2}>
            <PrimaryTextField
              ...
              defaultValue=""
              InputProps={{
                endAdornment: <InputAdornment position="end">kgCO₂</InputAdornment>,
              }}
            />
            <Iconify icon={'bx:transfer'} width={22} height={22} />
            <PrimaryTextField
              disabled
              defaultValue=""
              InputProps={{
          ...
          <Stack direction="column" alignItems="center">
            <Typography variant="p">Value in reais</Typography>
            <Typography variant="h6">BRL 0.20</Typography>
          </Stack>
